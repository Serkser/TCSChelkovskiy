...
using TCSChelkovskiy;
using UserControl = System.Windows.Controls.UserControl;

namespace TCEvropeyskiy.Controls.keyboard
{
    /// <summary>
    ...
    public partial class CoolKeyBoard : UserControl
    {
        ...
        public ICommand ShiftCommand =>
            _shiftCommand ?? (_shiftCommand = new RelayCommand(a =>
            {
                //TODO Shift ёпта
                if (CapsPressed)
                {
        ...
        public ICommand CloseKeyBoardCommand =>
            _closeKeyBoardCommand ?? (_closeKeyBoardCommand = new RelayCommand(a => { IsOpen = false; }));

        public ICommand DeleteCommand =>
            _deleteCommand ?? (_deleteCommand = new RelayCommand(a => {  Send(Keys.Back, false); }));

        public ICommand SwitchLanguageCommand => _switchLanguageCommand ?? (_switchLanguageCommand = new RelayCommand(a =>
        {
        ...
        public ICommand SendKeysCommand => _sendKeysCommand ?? (_sendKeysCommand = new RelayCommand(a =>
        {
            try
            {
